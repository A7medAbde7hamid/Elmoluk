  ...
  return (
    <Layout>
      <SEO
        ...
        description="صالون الملوك - أفضل صالون حلاقة رجالي في العاشر من رمضان، الشرقية. حجز موعد، حلاقة شعر، تهذيب لحية، عناية بالبشرة، منتجات وباقات ملكية. احجز الآن."
        path="/"
        keywords="صالون الملوك, افضل صالون حلاقة, حلاق رجالي العاشر من رمضان, صالون حلاقة الشرقية, حلاقة شعر, تهذيب لحية, عناية بالرجال"
      />
      <JSONLD />
